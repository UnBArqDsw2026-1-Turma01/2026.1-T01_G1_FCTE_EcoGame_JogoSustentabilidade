...
- **Data de Realização**: 23/03/2026
- **Horário de Início**: 20:30
- **Horário de Término**: 21:40
- **Duração**: 1h10 min
- **Participantes**: Carlos, Gabriel, Heyttor, João, Matheus, Ryan, Yasmin
...
<p align="justify">
Para garantir a entrega dentro do cronograma, a equipe levantou possíveis funcionalidades que se alinhassem ao tema de Sustentabilidade. Foram estabelecidos como essenciais (Must Have) a movimentação do personagem, o sistema de coleta de itens e a progressão por fases. Funções complexas, como multiplayer e mundo aberto, foram descartadas nesta etapa para evitar sobrecarga no desenvolvimento, os requisitos mantidos podem ser consultados em <a href="../../iniciativas-extras/elicitacao/requisitos/">Requisitos</a>
</p>

### Planejamento da Design Sprint
<p align="justify">
Nesta fase, organizou-se o cronograma de trabalho e delegação da primeira entrega individual. Foi estruturado o cronograma das atividades assíncronas e encontros remotos para o <a href="../DIA-02/">dia 02</a> seguido pelos dias <a href="../DIA-03/">03</a> e <a href="../DIA-04/">04</a>. Como ação imediata, cada membro assumiu a responsabilidade de elaborar um <a href="../../artefatos-generalistas/04-Rich-pictures/">Rich Picture</a> para apresentação na reunião seguinte.
</p>
