...
| RF05 | Processar depósito/reciclagem | O sistema deve validar a proximidade à maquininha de reciclagem para processar e transformar itens do inventário. | Must | [aqui](../../../../administracao/reunioes/20260324.md)|
| RF06 | Sistema de craft | O sistema deve criar novos itens (úteis ou decorativos) a partir de combinações de materiais segundo receitas predefinidas, descontando-os do inventário. | Must |[aqui](../../../../administracao/reunioes/20260324.md)|
