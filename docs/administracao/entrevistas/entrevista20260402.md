...
O propósito desta entrevista é:
...
## 3. Roteiro de Questões Base

Perguntas norteadoras utilizadas durante a entrevista:

- Em algum momento você se sentiu confuso com alguma funcionalidade demonstrada?
- Ao ver o vídeo, ficaram claras as ações executadas pelo personagem? (ex: catar banana)
- O menu e os ícones são fáceis de entender? Estão legíveis?
...
## 4. Aferições e Observações

Resumo dos principais feedbacks coletados:
